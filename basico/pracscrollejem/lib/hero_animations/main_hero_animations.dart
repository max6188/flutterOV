...
import 'package:pracscrollejem/hero_animations/hero_dialog_route.dart';
import 'package:pracscrollejem/hero_animations/page1.dart';
import 'package:pracscrollejem/hero_animations/page2.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildCustomButton("Custom Hero Animation", Page1(),isCustom: true),
              Hero(
                tag: "hero1",
                child: ClipOval(
                  child: CustomLogo(
