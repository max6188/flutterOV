...
class _MyHomePageState extends State<MyHomePage> {
  ...
  File _cachedFile;
    ...
    print("directorio para subir ${tempDir.path}");
...
List<String> fileNames = <String>[
  'assets/photos/alca.jpg',
  'assets/photos/almendra.jpg',
  'assets/photos/conyta.jpg',
];
